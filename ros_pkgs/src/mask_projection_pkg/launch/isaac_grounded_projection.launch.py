...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("camera_info_topic", default_value="/rgbd_camera/camera_info"),
        DeclareLaunchArgument("annotated_topic", default_value="/top_view/grounded_sam/annotated_image"),
        DeclareLaunchArgument("mask_topic", default_value="/top_view/grounded_sam/mask_image"),
        DeclareLaunchArgument("detections_topic", default_value="/top_view/grounded_sam/detections_json"),
        DeclareLaunchArgument("output_cloud_topic", default_value="/top_view/labeled_points"),
        DeclareLaunchArgument("output_result_topic", default_value="/top_view/projection_result"),
        ...
        DeclareLaunchArgument("output_subdir", default_value="top_view"),
